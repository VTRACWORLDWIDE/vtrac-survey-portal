...
const phaseOneRoles = [
  ...
  { key: 'surveyDesigner', name: 'Survey Designer', scope: 'project', description: 'Builds questionnaires and reusable survey components.', permissions: ['surveys.design', 'responses.view'] },
